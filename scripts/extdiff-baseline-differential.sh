...
# status, entry counts, every (index, value) pair in returned order,
# stdout, stderr, exit status) to match byte for byte.
#
...
# branch had no part in, while saying nothing about the branch.
#
