...
* Manual and homepage: https://stp.github.io/
...
None of those steps is optional: ABC and mimalloc are submodules built as part of STP, LibBF is required, and a build with no SAT backend enabled does not configure.
