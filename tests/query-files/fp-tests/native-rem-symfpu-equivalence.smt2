...
; every value of (3,4). The oracle takes the same dividend expressed as an
...
(declare-fun native-rem () (_ FloatingPoint 3 4))
(declare-fun oracle-rem () (_ FloatingPoint 3 4))
