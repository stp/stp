...
; over every value of (3,4) and every rounding mode. The oracle takes the
...
; ordering a zero addend above a smaller nonzero product, and (3,4)-style
...
(declare-fun c () (_ FloatingPoint 3 4))
(declare-fun minus-zero () (_ FloatingPoint 3 4))
(declare-fun rm () RoundingMode)
(declare-fun native-fma () (_ FloatingPoint 3 4))
(declare-fun oracle-fma () (_ FloatingPoint 3 4))
