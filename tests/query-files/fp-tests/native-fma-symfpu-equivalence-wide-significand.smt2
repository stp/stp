...
; over every value of (3,6) and every rounding mode. The oracle takes the
...
; ordering a zero addend above a smaller nonzero product, and (3,6)-style
...
;
(set-logic QF_FP)
(declare-fun a () (_ FloatingPoint 3 6))
(declare-fun b () (_ FloatingPoint 3 6))
(declare-fun c () (_ FloatingPoint 3 6))
(declare-fun minus-zero () (_ FloatingPoint 3 6))
(declare-fun rm () RoundingMode)
(declare-fun native-fma () (_ FloatingPoint 3 6))
(declare-fun oracle-fma () (_ FloatingPoint 3 6))
