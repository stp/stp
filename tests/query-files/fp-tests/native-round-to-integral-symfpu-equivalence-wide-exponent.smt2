...
; encoding over every value of (4,4) and every rounding mode. The oracle
...
(declare-fun unit () (_ FloatingPoint 4 4))
(declare-fun minus-zero () (_ FloatingPoint 4 4))
(declare-fun rm () RoundingMode)
(declare-fun native-round () (_ FloatingPoint 4 4))
(declare-fun oracle-round () (_ FloatingPoint 4 4))
(define-fun one () (_ FloatingPoint 4 4) (fp #b0 #b0111 #b000))
