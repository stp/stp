; declare-fun with no arguments, the other spelling of a scalar declaration.
; See parser-zero-width-declare-const.smt2 for why a zero width cannot be let
; through.
