...
; CAP: BV abstraction record: record=0 node=[0-9]+ kind=BVMULT width=64 state=exact blocking=32 schemas=[0-9]+ exact=1 exact-bits=64 allowance=32 blocking-clauses=2048 blocking-literals=264192 exact-clauses=[1-9][0-9]* exact-vars=[1-9][0-9]* exact-us=[0-9]+
