...
;
; Sixteen reads over an eight-store may-alias chain: deep and shared
; enough that the later reads are abstracted to chain rows and pinned
; by refinement lemmas. -d checks the model against this input, chain
; semantics included.
;
; CHECK: ^sat
(set-logic QF_ABV)
